...
```
cd C:\Users\Documents\Codex\2026-08-28\wo
...
最后项目基本完工，最终版本参见文件 ProfessorSearch_CN_Testing.py 。
	
5不足

OpenAlex 对于国内发表的作者的支持限，很多国内的学术信息更新被忽略。教授的所属机构准确性也不足。我希望可以接入 CNKI API、Google Scholar 等更多数据源，做多源数据融合与去重，弥补这一缺点。
